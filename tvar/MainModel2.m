...
if RunEstimation
    ...
    Ctr =[
        1        0       0           0       ;%1: Inflatiom
        1        0       0           0       ;%2: Inflation Expectations
        1        1       0          -1       ;%3: Short term rate (3m TBILL)
        1        1       0          -1       ;%4: Expected Short Rate
        1        1       1          -1       ;%5: Long Rate (20y TBOND)
        1        1       1           0       ;%6: BAA
        ];
    ...
    df0tr = 100;
    %              pi^*      r^*        ts^*      cy
    SC0tr =    ([   2    1/sqrt(2)       1      1/sqrt(2)  ]).^2/400;%var(diff(Trend));
    S0tr =      [   2        1.5         1         1       ]';
    P0tr = diag([   1         1          1         1       ]);
    
    Psi =                  [ 2    1     1    .5      1        1       ];
    %                       pi   Epi   bill  Eill   bond      BAA
    S0cyc = zeros(n*p,1);
...
save OutMod2forCharts Time qR_bar qCy_bar qM_bar qPi_bar qTs_bar y
...
hold off
axis([0 4 0 inf])
filename=strcat(['./',FigSubFolder,'/HistScy.pdf']);
print('-dpdf', filename);
