...
% spec1010_18_2020Q1_0616.jl is set up to print the bands from narrowest on the
...
shockdecEnd = datenum('2020-03-31');
...
axis([-inf inf 2 14])
xlim([datenum('01-Jan-1960') datenum('01-Jan-2020')])
hold off
