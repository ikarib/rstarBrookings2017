%Pi + Yields + AAA + BAA + Productivity
clear;
clc;
close all;
...
RunEstimation = 1;
OutputName = 'OutputModel4Prod';
FigSubFolder = 'FiguresModel4Prod';
...
save OutMod4ProdforCharts Time qR_bar qCy_bar qM_bar qPi_bar qB_bar qTs_bar qSafe_bar qLiq_bar qDC_bar qG2_bar qG_bar y
